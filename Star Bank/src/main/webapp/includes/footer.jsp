	...
	<div class="container">
		<div class="agileits_updates_grids">
			<div class="col-md-6 agileits_updates_grid_left">
				...
				<div class="agileits_updates_grid_left_grid">
					<div class="col-xs-4 agileits_updates_grid_left1">
						<h4>
							15 <span>June <i>2016.</i></span>
						</h4>
					</div>
					<div class="col-xs-8 agileits_updates_grid_left1">
						<h5>
							<a href="single.html">fugiat quo voluptas</a>
						</h5>
			...
			<div class="col-md-6 agileits_updates_grid_right">
				...
				<ul id="flexiselDemo1">
					<li><img src="images/1.jpg" alt=" " class="img-responsive" />
					</li>
					<li><img src="images/3.jpg" alt=" " class="img-responsive" />
					</li>
					<li><img src="images/4.jpg" alt=" " class="img-responsive" />
					</li>
				</ul>
				...
				<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body panel_text">Anim pariatur cliche
								...
								dolor brunch. Food truck quinoa nesciunt laborum eiusmod.</div>
						</div>
					</div>
					<div class="panel panel-default">
			...
			<div class="col-md-4 w3agile_footer_grid w3agile_footer_grid1">
				...
				<ul>
					<li><span class="glyphicon glyphicon-menu-right"
						aria-hidden="true"></span><a href="about.html">About Us</a></li>
					<li><span class="glyphicon glyphicon-menu-right"
						aria-hidden="true"></span><a href="portfolio.html">Portfolio</a></li>
					<li><span class="glyphicon glyphicon-menu-right"
						aria-hidden="true"></span><a href="short-codes.html">Short
							Codes</a></li>
					<li><span class="glyphicon glyphicon-menu-right"
						aria-hidden="true"></span><a href="mail.html">Mail Us</a></li>
				</ul>
			</div>
			<div class="clearfix"></div>
		</div>
...
<div class="copy-right-social">
	<div class="container">
		...
		<div class="copy-right">
			<p>
				&copy; 2016 Barter. All rights reserved | Design by <a
