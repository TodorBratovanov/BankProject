...
import com.starbank.model.dao.TransferMoneyDAO;
...
public class TransferMoneyTest {
	...
	public void testTransferMoneyToMyAccounts()
		...
		assertTrue(new TransferMoneyDAO().transferMoneyToMyAccount(
	...
	public void testTransferMoneyToOtherAccount()
			throws IbanException, AccountException, InvalidStringException, IdException {
		assertTrue(new TransferMoneyDAO().transferMoneyToOtherAccount(
