...
//
//		int userid = new UserRepository().registerUser(new User(1, "SvaSe", "SKk", "SKjj", "+359877706176",
...
//
//		assertTrue(new UserRepository().isRegistrationConfirmed("kochev.svetoslav@gmail.com"));
//	}
//
//	@Test
//	public void testIsRegistred() throws SQLException, UserException {
//
//		assertTrue(new UserRepository().isRegistered("kochev.svetoslav@gmail.com"));
//	}
}
