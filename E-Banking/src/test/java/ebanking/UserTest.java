...
//		new UserDAO().transferMoneyToOtherAccount(new Deposit(1, 100, 100, "BG80BNBG96611020345678", 1, "GBP"), 20,
//				"BG61TTBB94003115068734");
//	}
//	
	@Test
	public void testTransferMoneyToMyAccounts()
		...
		assertTrue(new UserDAO().transferMoneyToMyAccount(new CurrentAccount(1, 80, 80, "BG62TTBB94001524310814", 1, "BG"),
